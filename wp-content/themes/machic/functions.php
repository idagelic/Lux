...
function machic_admin_styles() {
    ...
    wp_enqueue_script('machic-menu-extra',  get_template_directory_uri() .'/assets/js/admin/menu-extra.js', array('jquery'), '1.0', true);
    wp_enqueue_script('machic-register',    get_template_directory_uri() .'/assets/js/admin/register.js', array('jquery'), '1.0', true);
	wp_register_style( 'machic-klbicon', 	get_template_directory_uri() .'/assets/css/klbicon.css', false, '1.0');
}
...
function machic_scripts() {
	...
	if ( is_admin_bar_showing() ) {
		wp_enqueue_style( 'machic-klbtheme', MACHIC_INDEX_CSS . '/admin/klbtheme.css', false, '1.0');    
	}	

	if ( is_singular() ) wp_enqueue_script( 'comment-reply' );

	wp_enqueue_style( 'machic-typekit', 		MACHIC_INDEX_CSS . '/typekit.css', false, '1.0');
	wp_enqueue_style( 'bootstrap', 				MACHIC_INDEX_CSS . '/bootstrap.min.css', false, '1.0');
	wp_enqueue_style( 'select2', 				MACHIC_INDEX_CSS . '/select2.min.css', false, '1.0');
	wp_register_style( 'owl-carousel', 			MACHIC_INDEX_CSS . '/vendor/owl.carousel.min.css', false, '1.0');
	wp_register_style( 'owl-theme-default', 	MACHIC_INDEX_CSS . '/vendor/owl.theme.default.min.css', false, '1.0');
	wp_enqueue_style( 'machic-base', 			MACHIC_INDEX_CSS . '/base.css', false, '1.0');
	wp_enqueue_style( 'machic-klbicon', 		MACHIC_INDEX_CSS . '/klbicon.css', false, '1.0');
	...
	wp_enqueue_script( 'bootstrap-bundle',    	     MACHIC_INDEX_JS . '/bootstrap.bundle.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'select2-full',    	 	     MACHIC_INDEX_JS . '/select2.full.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'gsap',    	    		     MACHIC_INDEX_JS . '/vendor/gsap.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'hover-slider',    	         MACHIC_INDEX_JS . '/vendor/hover-slider.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'jquery-magnific-popup',      MACHIC_INDEX_JS . '/vendor/jquery.magnific-popup.min.js', array('jquery'), '1.0', true);
	if ( is_rtl() ) {
	wp_enqueue_script( 'machic-klbmenu-rtl',  		     MACHIC_INDEX_JS . '/vendor/klbMenu-rtl.js', array('jquery'), '1.0', true);
	} else {
	wp_enqueue_script( 'machic-klbmenu',  		     MACHIC_INDEX_JS . '/vendor/klbMenu.js', array('jquery'), '1.0', true);
	}
	wp_enqueue_script( 'perfect-scrolllbar',         MACHIC_INDEX_JS . '/vendor/perfect-scrollbar.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'swiper-bundle',    	         MACHIC_INDEX_JS . '/vendor/swiper-bundle.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'theia-sticky-sidebar',       MACHIC_INDEX_JS . '/vendor/theia-sticky-sidebar.min.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-productsorting',      MACHIC_INDEX_JS . '/custom/productSorting.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-producthover',        MACHIC_INDEX_JS . '/custom/productHover.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-producthoverSlider',  MACHIC_INDEX_JS . '/custom/productHoverSlider.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-sidebarfilter',       MACHIC_INDEX_JS . '/custom/sidebarfilter.js', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-sitescroll',          MACHIC_INDEX_JS . '/custom/sitescroll.js', array('jquery'), '1.0', true);
	wp_register_script( 'machic-counter',   		 MACHIC_INDEX_JS . '/custom/counter.js', array('jquery'), '1.0', true);
	wp_register_script( 'owl-carousel',   		     MACHIC_INDEX_JS . '/vendor/owl.carousel.min.js', array('jquery'), '1.0', true);
	wp_register_script( 'machic_flex_thumbs',        MACHIC_INDEX_JS . '/custom/flex_thumbs.js', array('jquery'), '1.0', true);
	wp_register_script( 'machic_mini_cart_slider',   MACHIC_INDEX_JS . '/custom/mini_cart_slider.js', array('jquery'), '1.0', true);
	wp_register_script( 'machic-loginform',   		 MACHIC_INDEX_JS . '/custom/loginform.js', array('jquery'), '1.0', true);
	wp_register_script( 'machic-googlemap',          '//maps.googleapis.com/maps/api/js?key='. $mapkey .'', array('jquery'), '1.0', true);
	wp_enqueue_script( 'machic-bundle',     	     MACHIC_INDEX_JS . '/bundle.js', array('jquery'), '1.0', true);
}
...
function machic_page_settings( $opt_id){
	...
	if ( class_exists( '\Elementor\Core\Settings\Manager' ) ) {
		...
		$output = $page_settings_model->get_settings( 'machic_elementor_'.$opt_id );
